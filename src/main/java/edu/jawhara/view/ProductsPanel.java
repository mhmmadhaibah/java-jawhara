...
public class ProductsPanel extends javax.swing.JPanel {
    ...
    private void customProductsTable()
    {
        ...
        productsTableColumnModel.getColumn(4).setCellRenderer(new ActionTableCellRenderer(aaEditDeleteActionTablePanel.class));
        productsTableColumnModel.getColumn(4).setCellEditor(new ActionTableCellEditor(actionTableEvent, aaEditDeleteActionTablePanel.class));
