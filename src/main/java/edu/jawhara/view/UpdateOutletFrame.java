 ...
 * @author mhmmadhaibah
 */
public class UpdateOutletFrame extends javax.swing.JFrame {
    private static final Connection conn = MyConnection.getConnection();

    private final int outletId;

    /**
     * Creates new form UpdateOutletFrame
     * 
     * @param outletId
     */
    public UpdateOutletFrame(int outletId) {
        initComponents();
    ...
    private void loadOutletForm()
    {
        try
        {
            String sqlq = "SELECT * FROM outlets WHERE id = ?";
            ...
            if (rslt.next())
            {
                ...
                jTextArea1.setText(rslt.getString("description"));
            }
        }
    ...
    private void initComponents() {
        ...
        jTextArea1.setPreferredSize(new java.awt.Dimension(300, 130));
    ...
    private void rButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rButton1ActionPerformed
        ...
        try
        {
            ...
            if (rslt.next() && rslt.getInt("id") != outletId)
            {
        ...
        try
        {
            String sqlq = "UPDATE outlets SET name = ?, description = ? WHERE id = ?";
            PreparedStatement stmt = conn.prepareStatement(sqlq);
            ...
            if (rslt > 0)
            {
                JOptionPane.showMessageDialog(rButton1, "Outlet updated successfully.");
                dispose();
            }
            else
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateOutletFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateOutletFrame(0).setVisible(true);
            }
        });
    }
